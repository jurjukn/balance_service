...
class BankServiceTest {
    ...
    static BankStatementsService bankStatementsService;
    ...
    public static void setup() {
        ...
        bankService = new BankService(fakeBankAccountsRepository, currencyService, bankStatementValidationService, csvService);
        bankStatementsService = new BankStatementsService(bankStatementValidationService, csvService, fakeBankAccountsRepository);

        bankAccountNumber1 = "123";
        bankAccountNumber2 = "222";

        BankStatement statement1 = new BankStatement(bankAccountNumber1, LocalDateTime.parse("2012-07-14T17:45:55.9483536"), "John Smith", "bill", new BigDecimal("13.5"), "USD");

        BankStatement statement2 = new BankStatement(bankAccountNumber1, LocalDateTime.parse("2014-07-14T17:45:55.9483536"), "Jack Samuel", "debt", new BigDecimal("-13.5"), "USD");

        BankStatement statement3 = new BankStatement(bankAccountNumber1, LocalDateTime.parse("2018-07-14T17:45:55.9483536"), "Megan Smith", "transaction", new BigDecimal("9.5"), "USD");

        BankStatement statement4 = new BankStatement(bankAccountNumber2, LocalDateTime.parse("2012-07-14T17:45:55.9483536"), "John Smith", "bill", new BigDecimal("13.5"), "USD");

        BankStatement statement5 = new BankStatement(bankAccountNumber2, LocalDateTime.parse("2014-07-14T17:45:55.9483536"), "Jack Samuel", "debt", new BigDecimal("-13.5"), "USD");

        BankStatement statement6 = new BankStatement(bankAccountNumber2, LocalDateTime.parse("2018-07-14T17:45:55.9483536"), "Megan Smith", "transaction", new BigDecimal("9.5"), "USD");
    ...
    void exportStatements() throws IOException {
        DataFilterDTO filterDTO1 = new DataFilterDTO(null, null);
        final InputStreamResource allStatements = bankStatementsService.exportStatements(filterDTO1);
        final InputStreamResource user1Statements = bankService.exportBankAccountStatements(bankAccountNumber1, filterDTO1);
